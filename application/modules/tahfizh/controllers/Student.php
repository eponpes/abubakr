...
class Student extends MY_Controller {
    ...
    * ********************************************************** */ 
    public function index() {
        ...
        if ($_POST) {
            ...
            if (!empty($this->data['students'])) {
                ...
                foreach ($this->data['students'] as $obj) {
                    ...
                    $attendance = $this->student->get_single('student_tahfizh', $condition);
                    ...
                    if (empty($attendance)) {
                        ...
                        $this->student->insert('student_tahfizh', $data);
                    }
                }
            }
            ...
            create_log('Has been process student tahfizh');   
        }
        ...
        $this->layout->title($this->lang->line('student') . ' ' . $this->lang->line('tahfizh') . ' | ' . SMS);
    ...
    * @return          : null 
    * ********************************************************** */ 
    public function update_single_tahfizh() {
        ...
        if ($this->student->update('student_tahfizh', array($field => $status, 'modified_at'=>date('Y-m-d H:i:s')), $condition)) {
            echo TRUE;
        } else {
            echo FALSE;
        }
    ...
    * @return          : null 
    * ********************************************************** */
    public function update_all_tahfizh() {

...
class Markforms_Model extends MY_Model {
    ...
    public function get_mark_forms_list_by_student($school_id, $class_id, $student_id, $academic_year_id, $quarter){
        
        $this->db->select('M.value, M.quarter');
        ...
        $this->db->where('M.quarter', $quarter);

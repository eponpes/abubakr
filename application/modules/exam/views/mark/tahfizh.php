                  ...
                  <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th colspan="4">Penilaian Tahsin</th>      
                        </tr>
                        <tr>                           
                            <th>Fashohah</th>                                               
                            <th>Tajwid</th>
                            <th>Kelancaran Hafalan</th>
                            <th>Catatan</th>            
                        </tr>
                    </thead>
                    <tbody id="fn_mark">   
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if(!empty($attendance)){ ?>
                                            <input type="number"  id="fashohah_<?php echo $obj->student_id; ?>"  itemid="<?php echo $obj->student_id; ?>"  value="<?php if(!empty($mark) && $mark->fashohah > 0 ){ echo $mark->fashohah; }else{ echo ''; } ?>"  name="fashohah[<?php echo $obj->student_id; ?>]" class="form-control form-mark col-md-7 col-xs-12 fn_mark_total"   autocomplete="off"/>
                                        <?php }else{ ?>
                                            <input readonly="readonly" type="number" value="0"  name="fashohah[<?php echo $obj->student_id; ?>]" class="form-control form-mark col-md-7 col-xs-12" />
                                        <?php } ?>
                                    </td>
                                    <td>
                                        <?php if(!empty($attendance)){ ?>
                                            <input type="number"  id="tajwid_<?php echo $obj->student_id; ?>"  itemid="<?php echo $obj->student_id; ?>"  value="<?php if(!empty($mark) && $mark->tajwid > 0 ){ echo $mark->tajwid; }else{ echo ''; } ?>"  name="tajwid[<?php echo $obj->student_id; ?>]" class="form-control form-mark col-md-7 col-xs-12 fn_mark_total"   autocomplete="off"/>
                                        <?php }else{ ?>
                                            <input readonly="readonly" type="number" value="0"  name="tajwid[<?php echo $obj->student_id; ?>]" class="form-control form-mark col-md-7 col-xs-12" />
                                        <?php } ?>
                                    </td>
                                    
                                    <td>
                                        <?php if(!empty($attendance)){ ?>
                                        <input type="number"  id="fluency_<?php echo $obj->student_id; ?>" itemid="<?php echo $obj->student_id; ?>"   value="<?php if(!empty($mark) && $mark->fluency > 0 ){ echo $mark->fluency; }else{ echo ''; } ?>"  name="fluency[<?php echo $obj->student_id; ?>]" class="form-control form-mark col-md-7 col-xs-12 fn_mark_total"  autocomplete="off"/>
                                        <?php }else{ ?>
                                            <input readonly="readonly" type="number" value="0"  name="fluency[<?php echo $obj->student_id; ?>]" class="form-control form-mark col-md-7 col-xs-12"  />
                                        <?php } ?>
                                    </td>
                                    <td>
                                        <?php if(!empty($attendance)){ ?>
                                        <input type="text"  id="tahfizh_note_<?php echo $obj->student_id; ?>" itemid="<?php echo $obj->student_id; ?>"   value="<?php if(!empty($mark)  ){ echo $mark->tahfizh_note; }else{ echo ''; } ?>"  name="tahfizh_note[<?php echo $obj->student_id; ?>]" class="form-control form-mark col-md-7 col-xs-12 fn_mark_total"  autocomplete="off"/>
                                        <?php }else{ ?>
                                            <input readonly="readonly" type="number" value="0"  name="tahfizh_note[<?php echo $obj->student_id; ?>]" class="form-control form-mark col-md-7 col-xs-12"  />
                                        <?php } ?>
                                    </td>
                                </tr>
                            <?php } ?>

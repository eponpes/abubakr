    ...
    <body>
        ...
        <section class="slider slider2" id="slider">
            <div class="tp-banner">
                <ul>
                    <li data-transition="fade" data-slotamount="7" data-masterspeed="1000">
                        <img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/slider/s21.jpg"  alt=""> 
                    ...
                    <li data-transition="cube" data-slotamount="7" data-masterspeed="1000">
                        <img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/slider/s22.jpg"  alt=""> 
                        <div class="tp-caption sfb"
                             data-x="center"
                             data-y="center"
                             data-hoffset="0"
                    ...
                    <li data-transition="cube" data-slotamount="7" data-masterspeed="1000">
                        <img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/slider/s23.jpg"  alt=""> 
                        <div class="tp-caption sfb"
                             data-x="center"
                             data-y="center"
                             data-hoffset="0"
            ...
            <div class="mouseSlider">
                <a href="#team" class="normal"><img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/mouse.png" alt=""></a>
                <a href="#team" class="hover"><img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/mouseh2.png" alt=""></a>
            </div>
        </section>
        <!--SLIDER END-->
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="singleService">
                                <div class="serImg">
                                    <img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/services/1.png" alt="">
                                </div>
                        ...
                        <div class="col-sm-4">
                            <div class="singleService">
                                <div class="serImg">
                                    <img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/services/2.png" alt="">
                                </div>
                        ...
                        <div class="col-sm-4">
                            <div class="singleService">
                                <div class="serImg">
                                    <img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/services/3.png" alt="">
                                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="teamTop">
                        <div class="col-sm-6">
                            <div class="teamBig">
                                <img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/team/1b.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-sm-6">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 sm_class">
                        <div class="singleTeam">
                            <img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/team/2.jpg" alt="">
                            <div class="teamDeg">
                                <h4>Joel Stevens</h4>
                    ...
                    <div class="col-sm-3 sm_class">
                        <div class="singleTeam">
                            <img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/team/3.jpg" alt="">
                            <div class="teamDeg">
                    ...
                    <div class="col-sm-3 sm_class">
                        <div class="singleTeam">
                            <img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/team/4.jpg" alt="">
                            <div class="teamDeg">
                                <h4>David Dennis</h4>
                    ...
                    <div class="col-sm-4 noPadding">
                        <div class="single_folio single_folio2">
                            <a href="work-detail.html">
                                <div class="polioThumb">
                                    <div class="overlayHover"></div>
                                    <img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/work/h2/4.jpg" alt="">
                                </div>
                            </a>
                            <div class="folio_hover2">
                                <h6 class="color_yellow text-uppercase bold">Recent Casestudy</h6>
                    ...
                    <div class="col-sm-4 noPadding">
                        <div class="single_folio single_folio2">
                            <a href="work-detail.html">
                                <div class="polioThumb">
                                    <div class="overlayHover"></div>
                                    <img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/work/h2/5.jpg" alt="">
                                </div>
                            </a>
                            <div class="folio_hover2">
                                <h6 class="color_yellow text-uppercase bold">Recent Casestudy</h6>
                    ...
                    <div class="col-lg-5">
                        <div class="chooseUsContent">
                            ...
                            <div class="signatureandname">
                                ...
                                <img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/signature.jpg" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="imagesDiv chooseUsImg">
                            <img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/choose.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-4">
                        <div class="singleClient">
                            <a href="#"><img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/client/1.jpg" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-4">
                        <div class="singleClient">
                            <a href="#"><img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/client/2.jpg" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-4">
                        <div class="singleClient">
                            <a href="#"><img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/client/3.jpg" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-4">
                        <div class="singleClient">
                            <a href="#"><img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/client/4.jpg" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-4">
                        <div class="singleClient">
                            <a href="#"><img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/client/5.jpg" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-4">
                        <div class="singleClient">
                            <a href="#"><img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/client/6.jpg" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-4">
                        <div class="singleClient">
                            <a href="#"><img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/client/7.jpg" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-4">
                        <div class="singleClient">
                            <a href="#"><img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/client/8.jpg" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-4">
                        <div class="singleClient">
                            <a href="#"><img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/client/9.jpg" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-4">
                        <div class="singleClient">
                            <a href="#"><img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/client/10.jpg" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-4">
                        <div class="singleClient">
                            <a href="#"><img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/client/11.jpg" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-4">
                        <div class="singleClient">
                            <a href="#"><img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/client/12.jpg" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-4">
                        <div class="singleClient">
                            <a href="#"><img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/client/13.jpg" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-4">
                        <div class="singleClient">
                            <a href="#"><img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/client/14.jpg" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-4">
                        <div class="singleClient">
                            <a href="#"><img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/client/15.jpg" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-4">
                        <div class="singleClient">
                            <a href="#"><img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/client/16.jpg" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-4 noPadding">
                        <div class="singleBlog">
                            <div class="blogThumb">
                                <img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/blog/1.jpg" alt="">
                            </div>
                            <div class="blogDec">
                                ...
                                <div class="blogBott">
                                    ...
                                    <div class="blogComs"><img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/comment.png" alt=""><a href="#">2 Comments</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4 noPadding">
                        <div class="singleBlog">
                            <div class="blogThumb">
                                <img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/blog/2.jpg" alt="">
                            </div>
                            <div class="blogDec">
                                <div class="blogDate">December, 20, 2019</div>
                    ...
                    <div class="col-sm-4 noPadding">
                        <div class="singleBlog">
                            <div class="blogThumb">
                                <img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/blog/3.jpg" alt="">
                            </div>
                            <div class="blogDec">
                                <div class="blogDate">December, 20, 2019</div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="singleSay saypaddingR text-center">
                            <div class="sayThumb">
                                <img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/say/1.jpg" alt="">
                    ...
                    <div class="col-sm-6">
                        <div class="singleSay saypaddingl text-center">
                            <div class="sayThumb">
                                <img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/say/2.jpg" alt="">
                    ...
                    <div class="col-sm-6">
                        <aside class="widget">
                            <div class="textWidget">
                                <div class="flogow">
                                    <div class="flogo">
                                        <a href="index.html"><img src="<?php echo VENDOR_URL; ?>/<?php echo $theme; ?>/images/flogo.png" alt=""></a>
                                    </div>
                                    <div class="logo logoText hidden">

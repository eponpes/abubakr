            ...
            <div class="col-md-12 col-sm-12">
                <div class="admission-form">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            <div class="form-field">
                                <div class="field-title"><?php echo $this->lang->line('name'); ?> Lengkap:</div> 
                                <div class="field-value"></div> 
                            </div>
                        </div> 
                        <div class="col-md-6 col-sm-6">
                            <div class="form-field">
                                <div class="field-title">Tempat / <?php echo $this->lang->line('birth_date'); ?>:</div> 
                                <div class="field-value"></div> 
                            </div>
                        </div>                                              
                    </div>
                    ...
                    <div class="row">                                           
                        <div class="col-md-6 col-sm-6">
                            <div class="form-field">
                                <div class="field-title">Berat:</div> 
                                <div class="field-value"></div> 
                            </div>
                        </div>   
                        <div class="col-md-6 col-sm-6">
                            <div class="form-field">
                                <div class="field-title"><?php echo $this->lang->line('height'); ?>:</div> 
                                <div class="field-value"></div> 
                            </div>
                        </div>   
                    </div>
                    <div class="row">                                           
                        <div class="col-md-3 col-sm-3">
                            <div class="form-field">
                                <div class="field-title">Anak ke:</div> 
                                <div class="field-value"></div>
                            </div>
                        </div>  
                        <div class="col-md-3 col-sm-3">
                            <div class="form-field">
                                <div class="field-title">Dari:</div> 
                                <div class="field-value"></div>  
                            </div>
                        </div>   
                        <div class="col-md-6 col-sm-6">
                            <div class="form-field">
                                <div class="field-title">No NISN:</div> 
                                <div class="field-value"></div> 
                            </div>
                        </div>   
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="form-field">
                                <div class="field-title">Penghasilan Per Bulan:</div> 
                                <div class="field-value"></div> 
                            </div>
                        </div>
                    </div>

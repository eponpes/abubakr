<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-bar-chart"></i><small> <?php echo $this->lang->line('student'); ?> <?php echo $this->lang->line('tahfizh'); ?> <?php echo $this->lang->line('report'); ?></small></h3>                
            ...
            <?php $this->load->view('quick_report'); ?>   
             ...
             <div class="x_content filter-box no-print"> 
                <?php echo form_open_multipart(site_url('report/stahfizh'), array('name' => 'sattendance', 'id' => 'sattendance', 'class' => 'form-horizontal form-label-left'), ''); ?>
                <div class="row">                    
                           ...
                           <div class="col-sm-6 col-xs-6  col-sm-offset-3 col-xs-offset-3 layout-box">
                               <p>
                                  <div><img   src="<?php echo UPLOAD_PATH; ?>/logo/<?php echo $this->gsms_setting->logo; ?>" alt="" width="70" /></div>
                                   ...
                                   <h4 class="head-title ptint-title"><i class="fa fa-bar-chart"></i><small> <?php echo $this->lang->line('student'); ?> <?php echo $this->lang->line('tahfizh'); ?> <?php echo $this->lang->line('report'); ?></small></h4>                
                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in active" id="tab_tabular" >
                            ...
                            <table class="datatable-responsive table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <td><?php echo $this->lang->line('student'); ?> <i class="fa fa-long-arrow-down blue"></i> - <?php echo $this->lang->line('date'); ?> <i class="fa fa-long-arrow-right blue"></i></td>
                                ...
                                <tbody>   
                                    <?php  $count = 1; if(isset($students) && !empty($students)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <?php $attendance = get_student_monthly_tahfizh($obj->id, $academic_year_id, $class_id, $section_id, $month_number ,$days); ?>
                                            <?php if(!empty($attendance)){ ?>
                                                <?php foreach($attendance AS $key ){ ?>
                                                    <?php 
                                                        $getdata = json_decode($key);
                                                        $type = !empty($getdata->type)?$getdata->type:'';
                                                        $shaff = !empty($getdata->type)?$getdata->shaff:'';
                                                        $shaffo = !empty($getdata->type)?$getdata->shaffo:'';
                                                        $shaffn = !empty($getdata->type)?$getdata->shaffn:'';
                                                        if($type == "M"){
                                                            $label = "Murojaah";
                                                        } else if($type == "Z"){
                                                            $label = "Ziyadah";
                                                        ...
                                                        $labelshaff = $shaff . ' hal';
                                                        if(!empty($shaffo)){
                                                            $labelshaff = $shaffo . ' hal';
                                                        }

                                                        $datatitle = $label." ".$labelshaff." : ".$shaffn
                                                    ?>

                                                    <td data-toggle="tooltip" title="<?php echo $datatitle; ?>"> <?php echo $type ? $type : '<i style="color:red;">--</i>'; ?></td>
                                                <?php } ?>
                                            <?php } ?>
                                        </tr>
                                        <?php } ?>                                     
